...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(csrf -> csrf.disable())
				.authorizeHttpRequests(request -> request.requestMatchers("/login", "/signup","/static/**",  "/news/search-news/**", "/short-reads/get-all-ShortReads", "/news/get-all-News", "/article/get-all-article").permitAll())
